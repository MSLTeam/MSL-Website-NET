...
2024/7/14 更新
   ...
   请用户仔细阅读以下全部内容，当用户点击本软件首次启动时对话框内的“同意”按钮，或使用本软件提供的在线服务时，则应视为用户已经详细阅读并同意本协议的全部内容，且**同意遵守**本协议的规定。
...
## 使用须知
   ...
   6. 用户可自主管理本软件及本软件所运行的相关进程、服务（包括但不限于Minecraft服务器、内网桥接/点对点联机等），也可自主设置其相关信息，但本软件和本软件关联的所有进程、服务中**不允许**出现包括但不限于涉及种族/宗教、国家政治、国家领导人、淫秽/粗俗内容、诽谤/恐吓、宗教或宗教人物、工作人员、攻击性的、侮辱性的、可能引起误会地、违禁药品等内容，若出现这些内容，其法律责任和相关后果由用户自行承担。

   7. 用户应当是使用本软件运行的相关进程、服务（如Minecraft服务器、内网桥接/点对点联机等）的第一责任人，若其中出现违法违规行为或不当言论，相关后果由用户自行承担；同时，用户也应当是其他有使用前面所提到进程、服务的进程（如使用本软件联机功能的Minecraft游戏）的第一责任人，若其中出现违法违规行为或不当言论，相关后果由用户自行承担。

   8. 用户应当自行承担其所发布的信息内容所涉及的法律责任。此外，用户**不得**发布下列任何内容，若您发布下述任何内容，则开发者有权视情节严重程度，依据本协议及法律法规，对您做出包括但不限于终止服务等处理措施；情节严重的，开发者将移交有关行政管理机关给予行政处罚，或者追究您的刑事责任：
...
## 数据收集与使用
   ...
   若您同意本使用协议且使用本软件的**在线服务**，我们会收集以下信息：
      ...
      软件崩溃时，可能会在经用户同意的情况下，上传软件在系统运行的日志（含有部分系统信息），以帮助解决问题和改善软件；
...
## 免责声明
   ...
   4. 用户理解并同意，若以错误方式、非通过本软件的手段使用本软件**在线服务**以及本软件所下载的相关文件，其造成的后果由用户自行承担，若导致财产损毁、版权或知识产权被侵犯等问题，开发者概不负责，不会也不能承担任何法律责任。
...
## 知识产权
   ...
   2. 本软件所使用的第三方服务归相关版权方所有，包括但不限于：
      ...
      1. 本软件为沙盒游戏**Minecraft**（其最终解释权归Microsoft公司和Mojang Studio工作室）的服务器管理和游戏联机工具。 用户应当遵守**Minecraft最终用户许可协议**（MinecraftEULA）和中国区代理公司网易在中国大陆实行的相关政策，不得将游戏本体内容用于商业用途，或实施其他被**Minecraft最终用户许可协议**所禁止的行为。
