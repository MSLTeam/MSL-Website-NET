...
export default hopeTheme({
  ...
  iconAssets: ["https://cdn.bootcdn.net/ajax/libs/font-awesome/6.6.0/css/fontawesome.min.js",
"https://cdn.bootcdn.net/ajax/libs/font-awesome/6.6.0/css/brands.min.js",
